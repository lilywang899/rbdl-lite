...
const char *link_name[] =
    {
        "base_link",
        "link1_1_1", "link2_1_1", "link3_1_1",
        "link4_1_1", "link5_1_1", "link6_1_1"};
#endif

KinModel::KinModel(RigidBodyDynamics::Model *model) : gravity_(9.81) {
    model_ = model;
...
void KinModel::UpdateKinematics(const dynacore::Vector &q, const dynacore::Vector &qdot) {
...
void KinModel::_UpdateCentroidFrame(const dynacore::Vector &q, const dynacore::Vector &qdot) {
    double mass;
...
void KinModel::getJacobian(int link_id, dynacore::Matrix &J) {
    ...
    if (bodyid >= model_->fixed_body_discriminator) {
        CalcPointJacobian6D(*model_, q, bodyid,
                            model_->mFixedBodies
                                [bodyid - model_->fixed_body_discriminator]
                                    .mCenterOfMass,
                            J, false);
    } else {
        CalcPointJacobian6D(*model_, q, bodyid,
...
unsigned int KinModel::_find_body_idx(int id) const {
    ...
    case robot_link::link1_1_1:
        return model_->GetBodyId("link1_1_1");
    case robot_link::link2_1_1:
        return model_->GetBodyId("link2_1_1");
    case robot_link::link3_1_1:
        return model_->GetBodyId("link3_1_1");
    case robot_link::link4_1_1:
        return model_->GetBodyId("link4_1_1");
    case robot_link::link5_1_1:
        return model_->GetBodyId("link5_1_1");
    case robot_link::link6_1_1:
        return model_->GetBodyId("link6_1_1");
    default:
        std::cout << "unkonown id" << std::endl;
    }
    return 0;
