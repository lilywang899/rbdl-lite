    ...
    if (model.mJoints[joint_id].mDoFCount == 1
        ...
        if (model.mJoints[joint_id].mJointType == JointTypeRevolute) {
            ...
            SpatialTransform rot = Xrot(
                q[model.mJoints[joint_id].q_index], Vector3d(model.mJoints[joint_id].mJointAxes[0][0], model.mJoints[joint_id].mJointAxes[0][1], model.mJoints[joint_id].mJointAxes[0][2]));
