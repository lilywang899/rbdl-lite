...
struct RBDL_DLLAPI Joint {
    Joint() : mJointAxes(NULL),
              mJointType(JointTypeUndefined),
              mDoFCount(0),
              q_index(0){};
    Joint(JointType type) : mJointAxes(NULL),
                            mJointType(type),
                            mDoFCount(0),
                            q_index(0),
    ...
    Joint(JointType type, int degreesOfFreedom) : mJointAxes(NULL),
                                                  mJointType(type),
                                                  mDoFCount(0),
                                                  q_index(0),
                                                  custom_joint_index(-1) {
    ...
    Joint(const Joint &joint) : mJointType(joint.mJointType),
