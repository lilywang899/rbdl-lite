...
struct RBDL_DLLAPI SpatialRigidBodyInertia {
    ...
    SpatialRigidBodyInertia(
        double mass, const Vector3d &com_mass, const Matrix3d &inertia) : m(mass), h(com_mass),
                                                                          Ixx(inertia(0, 0)),
    ...
    SpatialRigidBodyInertia(double m, const Vector3d &h,
                            ...
                            const double &Izx, const double &Izy, const double &Izz) : m(m), h(h),
                                                                                       Ixx(Ixx),
                                                                                       Iyx(Iyx), Iyy(Iyy),
...
struct RBDL_DLLAPI SpatialTransform {
    SpatialTransform() : E(Matrix3d::Identity(3, 3)),
                         r(Vector3d::Zero(3, 1)) {}
    SpatialTransform(const Matrix3d &rotation, const Vector3d &translation) : E(rotation),
                                                                              r(translation) {}
  ...
  */
    SpatialRigidBodyInertia apply(const SpatialRigidBodyInertia &rbi) {
        return SpatialRigidBodyInertia(
            rbi.m,
            E * (rbi.h - rbi.m * r),
            E * (Matrix3d(rbi.Ixx, rbi.Iyx, rbi.Izx, rbi.Iyx, rbi.Iyy, rbi.Izy, rbi.Izx, rbi.Izy, rbi.Izz) + VectorCrossMatrix(r) * VectorCrossMatrix(rbi.h) + (VectorCrossMatrix(rbi.h - rbi.m * r) * VectorCrossMatrix(r)))
                * E.transpose());
    }
  ...
  */
    SpatialRigidBodyInertia applyTranspose(const SpatialRigidBodyInertia &rbi) {
        ...
        return SpatialRigidBodyInertia(
            rbi.m,
            E_T_mr,
            E.transpose() * Matrix3d(rbi.Ixx, rbi.Iyx, rbi.Izx, rbi.Iyx, rbi.Iyy, rbi.Izy, rbi.Izx, rbi.Izy, rbi.Izz) * E
